...
export function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen h-[150dvh] w-full relative scroll-mt-20 flex justify-center pt-24 lg:pt-32"
    >
      ...
      <article className="relative z-10 w-full flex flex-col mx-auto select-none">
        <div className="flex flex-col gap-2 lg:gap-3 items-center text-center">
          ...
          <p className="text-sm lg:text-lg text-gray-400 leading-relaxed mt-1 lg:mt-0 max-w-xs lg:max-w-md text-pretty">
          ...
          <div className="flex flex-col items-center gap-2 lg:gap-4 mt-2 lg:mt-8 w-full">
            <Button className="relative bg-[#32844e] text-white font-medium text-[17px] px-4 py-[0.35em] pl-5 h-[2.8em] rounded-[0.9em] flex items-center overflow-hidden cursor-pointer ">
              ...
              <div
                className="absolute right-[0.3em] bg-white h-[2.2em] w-[2.2em] rounded-[0.7em] flex items-center justify-center transition-all duration-300 active:scale-95"
              >
                <ForwardArrow />
              </div>
            </Button>
          ...
          <div className="relative w-full lg:w-4xl lg:mt-2">
            <Image
              src={DashImage}
              alt="CashFlow Dashboard Preview"
              className="w-full px-2 h-auto object-cover absolute top-2 lg:top-0 left-1/2 -translate-x-1/2 drop-shadow-xl drop-shadow-black/60 select-none"
              priority
            />
          </div>
        </div>
