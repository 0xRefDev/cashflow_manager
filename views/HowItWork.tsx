    ...
    >
      ...
      <article className="flex flex-col justify-center xl:justify-start">
        <div className="flex px-4 lg:px-5 justify-start text-center">
          <h2 className="text-xl lg:text-3xl font-bold leading-tight tracking-tight font-manrope text-pretty animate-fade-right">The precision tool for <span className="text-landing-primary underline underline-offset-4">financial clarity</span></h2>
        </div>
        <section className="grid grid-cols-1 grid-rows-4 lg:grid-cols-3 lg:grid-rows-2 px-6 py-6 gap-4 animate-fade-up animate-delay-200">
